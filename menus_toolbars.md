...
Класс QToolBar реализует передвигаемую панел для быстрого доступа к набору различных действий приложения.
