...
Мы сохраняем выбранное значение в переменную cur_width и перерисовываем виджет.
...
Здесь мы рисуем числа на шкале. Для определения позиции чисел, мы должны получить ширину строки.
